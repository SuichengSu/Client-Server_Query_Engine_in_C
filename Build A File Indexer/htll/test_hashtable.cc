...
TEST(Hashtable, LookupInHashtable) {
    ...
    // TODO(done): Test looking up something not in the table
    const char* something = "something";
    MyThing *thing99 = CreateMyThing(99, something);
    HTKeyValue somethingKV;
    somethingKV.key = FNVHashInt64(thing99->number);
    somethingKV.value = thing99;
    int result_99 = LookupInHashtable(ht, FNVHashInt64(thing99->number), &somethingKV);
    EXPECT_EQ(result_99, -1);
